...
#save('mu_map_interpolated_nvsmu_l0p6_bigOmega.npy', mu_map_interpolated)
#save('mu_map_interpolated_nvsmu_l0p55_bigOmega.npy', mu_map_interpolated)
#save('mu_map_interpolated_nvsmu_l0p5_bigOmega.npy', mu_map_interpolated)
#save('mu_map_interpolated_nvsmu_l0p45_bigOmega.npy', mu_map_interpolated)

save(savename, mu_map_interpolated)
